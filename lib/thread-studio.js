...
export const threadStudioTheme = {
  ...
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#12355B, #12355B)",
    ...
    "--color-on-accent": "light-dark(#FFFFFF, #00336C)",
    "--color-neutral": "light-dark(#181C221A, #DFE2EC33)",
    "--color-background-surface": "light-dark(#FFFFFF, #FFFFFF)",
    "--color-background-body": "light-dark(#F8FAFC, #F8FAFC)",
    ...
    "--color-background-muted": "light-dark(#EEF2F6, #EEF2F6)",
    "--color-text-primary": "light-dark(#1E293B, #1E293B)",
    "--color-text-secondary": "light-dark(#64748B, #64748B)",
    "--color-text-disabled": "light-dark(#9AA7B8, #9AA7B8)",
    "--color-text-accent": "var(--color-accent)",
    "--color-icon-accent": "var(--color-accent)",
    "--color-icon-primary": "light-dark(#000000, #FAFCFF)",
    "--color-icon-secondary": "light-dark(#2B303C, #C0C6D5)",
    "--color-icon-disabled": "light-dark(#8B919E, #595E6B)",
    ...
    "--color-border": "light-dark(#E2E8F0, #E2E8F0)",
    "--color-border-emphasized": "light-dark(#C7D1DE, #C7D1DE)",
    "--color-skeleton": "light-dark(#A5ABB9, #414753)",
    "--color-track": "light-dark(#E2E8F0, #E2E8F0)",
